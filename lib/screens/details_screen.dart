                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      ChapterCard(
                        name: "Influencer",
                        chapterNumber: 3,
                        tag: "Influencer easily like never before",
                        press: () {},
                      ),
                      ChapterCard(
                        name: "win",
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            offset: Offset(0, 10),
            blurRadius: 33,
            color: Color(0xFFD3D3D3).withOpacity(.38),
          ),
        ],
      ),
      child: Row(
                ...
                children: <Widget>[
                  Expanded(
                    child: Column(
                      children: <Widget>[
                        Text(
                          "When the earth is flat and everyone wanted to win the game of the best and people ..... ",
                          maxLines: 5,
